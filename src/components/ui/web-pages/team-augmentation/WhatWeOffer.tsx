        ...
        <div>
            <div className=" -mt-6 mb-20">
                <div className="container mx-auto text-center">
                    <ComponentTitle className='text-[#5A5A5A] flex-center pb-6'>What We Offer </ComponentTitle>
                    <div className=' flex-center w-full mb-10'>
                        <p className='text-center text-[22px] leading-[140%] tracking-wide text-[#7B7B7B] w-[35%]'>Betopia Limited helps U.S. tech companies access <span className=' font-bold'>pre vetted global IT professionals to </span></p>
                    </div> 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div key={index} className="flex flex-col items-center text-center space-y-4">
                            <div className="">
                                <Image src={item.image} alt={item.title} width={60} height={60} className="w-[60px] h-[60px] object-contain" />
                            </div>
