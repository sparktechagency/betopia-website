...
const IndustriesWeServe = () => {
    return (
        <div
            className='py-10 relative h-[680px] w-full'
            style={{
        ...
        >
            ...
            <div className="container mx-auto relative z-10">
                ...
                <div className='flex flex-col justify-center items-center'>
                    <p className='w-[40%] text-[#414042]/60 text-lg font-normal text-center pb-6'>
                        Timeline infographic design elements with circle shapes and marketing icons.
                        Business concept with 4 options, steps or processes.
                    </p>
                </div>
                            ...
                            >
                                ...
                                <div className="absolute bottom-[10%] text-[#858585] z-20 ">
                                    <div className="w-full flex flex-col items-start   px-4">
                                        ...
                                        <p className="text-[18px] text-white font-bold pb-1">{item?.title}</p>
                                    </div>
                                </div>
