...
const OurEngagementModals = () => {
    return (
        <div className='container mx-auto mb-20'>
            <div className=' pb-14'>
                <ComponentTitle className='flex-center pb-4 text-[#535353]'> Our Engagement <span className=' text-primary'>Models</span></ComponentTitle>
                <p className='text-[#41404280] font-medium text-center'>We provide flexible IT team augmentation services:</p>
            </div>
            ...
            <div>
                        ...
                        <div className="rounded-[22px] overflow-hidden flex items-center justify-center relative h-full">
                            ...
                            <div className="absolute left-10 bottom-[9%] text-[#858585] z-20 text-">
                                <div className="w-full flex flex-col items-start gap-1 px-4">
                                    <p>  <FaUsers size={62} color='#F79549' /> </p>
                                    <p className="text-[32px] text-primary pb-1">Dedicated Team</p>
                            ...
                            >
                                ...
                                <div className="absolute bottom-[11%] text-[#858585] z-20 text-center">
                                    <div className="w-full flex flex-col items-start  px-[50px]">
                                        <p className='pb-3'> {index === 1 ? <PiNetwork size={52} color='#F79549' /> : <ImPower size={42} color='#F79549' />} </p>
                                        <p className="text-[28px] text-primary pb-1">{item?.title}</p>
                ...
                <div className=' pt-[60px] flex items-center justify-center'> 
                    <OutlineButton className='mx-auto p-4 !text-[#656565] font-semibold'>Get Talent Profiles</OutlineButton>
                </div>
            </div>
        </div>
    );
