            ...
            <div className='container '>
                ...
                <div className=' grid grid-cols-2 gap-14 items-center'>
                    <div>
                        ...
                        <div className=' pb-6'>
                            <ComponentTitle className=' !text-center pb-2 !font-semibold'> <span className=' text-[#414042]'> Our Strategy & </span> <span className='text-primary'> Workflow </span> </ComponentTitle>

                            {
                                value?.description &&
                                <div className=' w-full gap-0.5'>
                                    <p className='text-[20px] text-[#757575]   w-[60%] leading-8'>{value?.description}</p>
                                </div>
                            }
                        </div>
                        <Image src="/our-strategy-workflow.png" alt="our-strategy-workflow" width={500} height={500} className='w-full h-[487px]' />
                    </div>
                ...
                <div className=' flex flex-col items-center justify-center gap-y-2 pt-8'>
                    <p className=' text-2xl font-bold text-[#414042] '>{value?.footer?.title}</p> 
                    {
                        value?.footer?.description &&
                        <div className=' text-xl font-normal text-[#414042]/60 '>{value?.footer?.description}</div>
                    }
                </div>
            </div>
        </div>
