        ...
        <div className=' container py-20 flex-center'>
            <div className=' w-[70%]'>
                <div className=' flex flex-col items-center justify-center gap-1 my-8  '>
                    <ComponentTitle className=' !text-center pb-2'> <span className=' text-[#000000]'> Our Strategy & </span> <span className='text-primary'>Method</span> </ComponentTitle>
                    <div className=' w-full flex-center flex-col gap-0.5'>
                        <p className='text-[20px] text-[#757575] text-center  w-[40%] leading-8'>We deliver identity security through a modular, scalable approach</p>
                    </div>
                </div>
                <div className="bg-[#F79549]/8 rounded-2xl p-6 sm:p-10 shadow-sm">
                    ...
                    {identityLifecycleData.map((item, index) => (
                        <div
                            key={index}
                            className="grid grid-cols-3 items-center text-left py-3 border-b border-gray-200 last:border-none"
                        >
