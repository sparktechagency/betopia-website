    ...
    return (
        <div className=' bg-[#F79549]/12 py-20 '>
            ...
            <div className=' flex-center mb-5'>
                <ComponentTitle className=' !text-center pb-2 !font-semibold'> <span className=' text-[#414042]'> Solution Portfolio </span> <span className='text-primary'> Highlights </span> </ComponentTitle>
            </div>
            ...
            <div className='container grid grid-cols-2  gap-5 items-center'>
                ...
                <div>
                    <Image src="/solution-portfolio.png" alt="solution-portfolio" width={600} height={600} className='w-full h-[595px]' />
                </div>
