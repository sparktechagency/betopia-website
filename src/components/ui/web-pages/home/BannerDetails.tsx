...
const BannerDetails = () => {
  return (
    <div className="  w-full z-10 bg-[#000000E5]/90 md:bg-gradient-to-r from-[#f8fcfc]  to-[#e0dfdf] md:-mt-[25px] py-[40px] md:py-[100px]">
      ...
      <div className=" container flex flex-col md:flex-row items-center gap-6 md:gap-0 z-20  ">
        <div className=" w-full z-20">
          <Image
            ...
            height={600}
            width={590}
            className="rounded-lg md:h-[580px] md:w-[650px] object-cover"
          />
        </div>

        <div className="w-full text-lg md:text-xl leading-10 tracking-wide text-[#B7B7B7]  md:text-gray-600 ">
