...
const BannerDetails = () => {
    return (
        <div className='  bg-gradient-to-b from-[#0a0d0e]  to-[#173e4d] -mt-[102px]  w-full z-10'>
            {/* <div className=" w-full h-full bg-black/60 "></div>  */}
            <div className=' container flex items-start pb-[80px] z-20  '>
                <div className=' w-[48%] -mt-6 z-20'>
                    <Image src={"/banner.png"} alt='' height={600} width={590} className='rounded-lg h-[550px] w-[550px]' />
                </div>

                <div className=' w-[52%] text-[#b7b7b7a2] text-2xl '>
