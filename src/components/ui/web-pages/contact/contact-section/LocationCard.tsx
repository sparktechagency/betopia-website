export default function LocationCard() {
  return (
    <div className="absolute bottom-6 left-6 right-6 bg-white rounded-xl shadow-lg p-4 py-8 flex items-start gap-3 max-w-[370px]">
      ...
      <div className="flex-1">
        <h5 className="text-primary font-semibold text-base mb-1">
          Betopia Limited
        </h5>
