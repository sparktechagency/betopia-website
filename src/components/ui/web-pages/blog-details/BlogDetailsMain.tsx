...
const BlogDetailsMain: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className='container grid grid-cols-12 mb-8 '>
                <div className='col-span-4 border-t border-r border-[#F79549]  '>
                    <div className='py-5 border-b border-[#F79549]'>
                        <Sumarry publishingDate={blogDetails.publishDate} category={blogDetails.category} readingTime={blogDetails.readingTime} authorName={blogDetails.authorName} />
                    </div>
                    <div className=' pr-10'>
                ...
                <div className='col-span-8 border-t border-[#F79549]'>
                    ...
                    <div className=' pl-10 pt-5'>
                        <Conclusion conclusion1={blogDetails.conclusion1} conclusion2={blogDetails.conclusion2} conclusionList={blogDetails.conclusionList} />
                    </div>
                </div>
            </div>

            <p className=' text-xl text-blue-900 text-center pb-8  '>Good or bad, we’d love to hear your thoughts. Find us on Linkedin  <span className='text-primary'>(@Linkedin)  </span> </p>
