...
const PartnerFAQs = () => {
    ...
    return (
        <div className=" container mb-20">
            <ComponentTitle className='text-[#5A5A5A] flex-center pb-6'>Partner FAQs </ComponentTitle>
            <div className=' flex-center w-full mb-9'>
                <p className='text-center text-[22px] leading-[140%] tracking-wide text-[#7B7B7B] w-[45%]'>Ask us, that is in your mind for better understanding of our vision and services that we offer for you.</p>
            </div>
