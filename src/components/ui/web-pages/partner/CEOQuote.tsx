                    ...
                    >
                        ...
                        <div className={` w-full  flex container
                            ...
                            <div className={` w-full py-14 justify-center  flex flex-col  `}>
                                <h1 className=' text-[48px] font-normal text-white tracking-wide pb-5 flex items-center gap-4'> <span className=' text-[#763300]'>  &quot; </span> {owner.slogan} <span className=' text-[#763300]'>  &quot; </span></h1>
                                <p className=' text-[22px] text-[#424242]  w-[79%] text-justify pb-10 tracking-wider leading-8'>{owner.bio}</p>
