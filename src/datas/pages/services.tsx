...
const EnterpriseInfrastructureSolutionsData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757500265/Cloud_Page_fap845.mp4",
    title: <p> <span className="text-white"> Enterprise   </span> <span className="text-primary"> Infrastructure Solutions </span>  </p>,
    description: "Betopia Limited offers Cloud Modernization & Managed Services, empowering businesses with tailored cloud solutions",
    details: {
...
const EnterpriseNetworkingSolutionsData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757500265/Cloud_Page_fap845.mp4",
    title: <p> <span className="text-white"> Enterprise   </span> <span className="text-primary"> Networking Solutions </span>  </p>,
    description: "Betopia Limited offers Cloud Modernization & Managed Services, empowering businesses with tailored cloud solutions",
    details: {
...
const CloudInfrastructureData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757500265/Cloud_Page_fap845.mp4",
    title: <p> <span className="text-white"> Cloud Infrastructure &   </span> <span className="text-primary"> Networking Solution </span>  </p>,
    description: "Betopia Limited offers Cloud Modernization & Managed Services, empowering businesses with tailored cloud solutions",
    details: {
...
const CyberSecuritySolutionsData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white"> Cyber Security   </span> <span className="text-primary">Solutions </span>  </p>,
    description: "Betopia Limited offers Cybersecurity Advisory & Managed Security Services, empowering businesses with tailored protection solutions",
    details: {
...
const CyberServicesData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white"> Cyber Security   </span> <span className="text-primary">Services </span>  </p>,
    description: "Betopia Limited offers Cybersecurity Advisory & Managed Security Services, empowering businesses with tailored protection solutions",
    details: {
...
const DigitalInnovationData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white"> Digital & APP   </span> <span className="text-primary">Innovation Solutions </span>  </p>,
    description: "Betopia Limited offers AI-Powered Solutions & Managed Services, empowering businesses with tailored intelligent systems",
    details: {
...
const DataSolutionsData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white"> Data Solutions   </span>   </p>,
    description: "Betopia Limited offers AI-Powered Solutions & Managed Services, empowering businesses with tailored intelligent systems",
    details: {
...
const AISolutionsData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white">AI Solutions  </span>   </p>,
    description: "Betopia Limited offers AI-Powered Solutions & Managed Services, empowering businesses with tailored intelligent systems",
    details: {
        title: "Scalable and Secure",
        subtitle: "IT Solutions",
...
const EndpointManagementData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white"> Endpoint Management & Security Solutions   </span>  </p>,
...
const IdentityManagementData = {
    videoSrc: "https://res.cloudinary.com/dreiyzj42/video/upload/v1757504188/cybersecurity_AI_page_omnfi9.mp4",
    title: <p> <span className="text-white"> Identity Management & Security Solutions   </span>  </p>,
    description: "Betopia Limited delivers customized Endpoint, Identity, and Productivity solutions, ensuring seamless security and operational efficiency.",
    details: {
