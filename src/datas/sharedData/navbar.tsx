    ...
    megaSections: [
      {
        ...
        subtitle: "Secure and empower your workforce with smart endpoint and identity solutions",
        icons: <FaFingerprint />,
        items: [
          {
      ...
      },
      {
        ...
        subtitle: "Empower your business with scalable, secure, and reliable cloud solutions",
        icons: <FiCloud />,
        items: [
          {
      ...
      },
      {
        ...
        subtitle: "Protect your digital assets with advanced, intelligent cybersecurity solutions",
        icons: <LuShieldCheck/>,
        items: [
          {
      ...
      {
        title: "AI Solutions",
        subtitle: "Transform your business with intelligent, data driven AI solutions",
        icons: <LuBrain />,
        items: [
          {
